...
export default class UHOShortTermMedicalQuestionsPage {
  ...
  private shortTermMedicalQuestionsPageElements = {
    ...
    DeclinedForInsurance: {
      NoOption: '//label[contains(@for, \'applicantQuestion_51021\') and text()=\'No\']',
      YesOption: '//label[contains(@for, \'applicantQuestion_51021\') and text()=\'Yes\']',
    },
    LivedInUSAforLessThan: {
      NoOption: '//label[contains(@for, \'applicantQuestion_37243\') and text()=\'No\']',
      YesOption: '//label[contains(@for, \'applicantQuestion_37243\') and text()=\'Yes\']',
    },
    UseTobacco: {
      NoOption: '//label[contains(@for, \'applicantQuestion_55480\') and text()=\'No\']',
      YesOption: '//label[contains(@for, \'applicantQuestion_55480\') and and text()=\'Yes\']',
    },

    // Medical History Information
    FamilyMemberExpectant: {
      NoOption: '//label[contains(@for, \'defaultQuestion_37253\') and text()=\'No\']',
      YesOption: '//label[contains(@for, \'defaultQuestion_37253\') and and text()=\'Yes\']',
    },
    DiagMedDisorders: {
      NoOption: '//label[contains(@for, \'applicantQuestion_37258\') and text()=\'No\']',
      YesOption: '//label[contains(@for, \'applicantQuestion_37258\') and and text()=\'Yes\']',
    },
    MedTestResults: {
      NoOption: '//label[contains(@for, \'applicantQuestion_37263\') and text()=\'No\']',
      YesOption: '//label[contains(@for, \'applicantQuestion_37263\') and and text()=\'Yes\']',
    },
    DiagMedDisordersHIV: {
      NoOption: '//label[contains(@for, \'applicantQuestion_37272\') and text()=\'No\']',
      YesOption: '//label[contains(@for, \'applicantQuestion_37272\') and and text()=\'Yes\']',
    },

    // Other Coverage Information
    HaveInsuranceWillNotTerminate: {
      NoOption: '//label[contains(@for, \'prevCovBenefits_37278\') and text()=\'No\']',
      YesOption: '//label[contains(@for, \'prevCovBenefits_37278\') and and text()=\'Yes\']',
    },

    // For Applicants with Current Short Term Medical Coverage With Us
    OtherGRIShortTerm: {
      NoOption: '//label[contains(@for, \'defaultQuestion_55507\') and text()=\'No\']',
      YesOption: '//label[contains(@for, \'defaultQuestion_55507\') and and text()=\'Yes\']',
    },
  };
  ...
  async clickOnContinueBtn(): Promise<void> {
    await this.page.click(this.shortTermMedicalQuestionsPageElements.ContinueButton);
  }
  ...
  async answerDeclinedForInsuranceQuestion(answer: YesNoAnswer): Promise<void> {
    ...
    */
    ...
    await this.page.click(this.shortTermMedicalQuestionsPageElements.DeclinedForInsurance.NoOption):
    await this.page.click(this.shortTermMedicalQuestionsPageElements.DeclinedForInsurance.YesOption);
  }

  async answerLivedInUSAforLessThanQuestion(answer: YesNoAnswer): Promise<void> {
    /*
    Question:
    ...
    */
    answer === YesNoAnswer.No? 
    await this.page.click(this.shortTermMedicalQuestionsPageElements.LivedInUSAforLessThan.NoOption):
    await this.page.click(this.shortTermMedicalQuestionsPageElements.LivedInUSAforLessThan.YesOption);
  }
  ...
  async answerUseTobaccoQuestion(answer: YesNoAnswer): Promise<void> {
    ...
    */
    answer === YesNoAnswer.No?
    await this.page.click(this.shortTermMedicalQuestionsPageElements.UseTobacco.NoOption):
    await this.page.click(this.shortTermMedicalQuestionsPageElements.UseTobacco.YesOption);
    }

    async answerFamilyMemberExpectantQuestion(answer: YesNoAnswer): Promise<void> {
    /*
    Question:
    ...
    */
    answer === YesNoAnswer.No?
    await this.page.click(this.shortTermMedicalQuestionsPageElements.FamilyMemberExpectant.NoOption):
    await this.page.click(this.shortTermMedicalQuestionsPageElements.FamilyMemberExpectant.YesOption);
    }
    ...
    */
    answer === YesNoAnswer.No?
    await this.page.click(this.shortTermMedicalQuestionsPageElements.DiagMedDisorders.NoOption):
    await this.page.click(this.shortTermMedicalQuestionsPageElements.DiagMedDisorders.YesOption);
    }
    ...
    */
    answer === YesNoAnswer.No?
    await this.page.click(this.shortTermMedicalQuestionsPageElements.MedTestResults.NoOption):
    await this.page.click(this.shortTermMedicalQuestionsPageElements.MedTestResults.YesOption);
    }
    ...
    */
    answer === YesNoAnswer.No?
    await this.page.click(this.shortTermMedicalQuestionsPageElements.DiagMedDisordersHIV.NoOption):
    await this.page.click(this.shortTermMedicalQuestionsPageElements.DiagMedDisordersHIV.YesOption);
    }

    async answerHaveInsuranceWillNotTerminateQuestion(answer: YesNoAnswer): Promise<void> {
    /*
    Question:
    ...
    */
    answer === YesNoAnswer.No?
    await this.page.click(this.shortTermMedicalQuestionsPageElements.HaveInsuranceWillNotTerminate.NoOption):
    await this.page.click(this.shortTermMedicalQuestionsPageElements.HaveInsuranceWillNotTerminate.YesOption);
    }
    ...
    */
    answer === YesNoAnswer.No?
    await this.page.click(this.shortTermMedicalQuestionsPageElements.OtherGRIShortTerm.NoOption):
    await this.page.click(this.shortTermMedicalQuestionsPageElements.OtherGRIShortTerm.YesOption);
    }
  ...
  async answerShortTermMedicalQuestions(answers: {
    ...
    await this.answerLivedInUSAforLessThanQuestion(answers.livedInUSAforLessThan);
    await this.answerUseTobaccoQuestion(answers.useTobacco);
    await this.answerFamilyMemberExpectantQuestion(answers.familyMemberExpectant);
    ...
    await this.answerHaveInsuranceWillNotTerminateQuestion(answers.haveInsuranceWillNotTerminate);
